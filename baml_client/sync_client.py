...
class BamlSyncClient:
    ...
    def JudgeConversation(self, conversation: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="JudgeConversation", args={
...
class BamlStreamClient:
    ...
    def JudgeConversation(self, conversation: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ConversationScore, types.ConversationScore]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="JudgeConversation", args={
            "conversation": conversation,
        })
        return baml_py.BamlSyncStream[stream_types.ConversationScore, types.ConversationScore](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def JudgeConversation(self, conversation: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="JudgeConversation", args={
            "conversation": conversation,
        }, mode="request")
        return __result__
